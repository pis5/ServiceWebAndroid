...
@NamedQueries({
    ...
    @NamedQuery(name = "Participation.findEventByParticipant", query = "SELECT p.participationPK.evenement FROM Participation p WHERE p.participationPK.participant = :participant")
})
